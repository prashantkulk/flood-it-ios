...
**Fix:** Add a back chevron button in the top bar, left of the moves counter.
**Status:** NOT DONE
...
**Fix:** Disable color buttons when `gameStatus != .playing` or `isWinningMove == true`.
**Status:** NOT DONE
...
**Fix:** Add a subtle level label (e.g., "Lv. 42") in the top bar.
**Status:** NOT DONE
...
**Fix:** Show "Done" instead of "Next" on the final level.
**Status:** NOT DONE
...
**Fix:** Call `.prepare()` on generators at appropriate times.
**Status:** NOT DONE
